...
本教程适用于适用于IDEA、Pytharm、WebStorm等软件。

1. [下载jetbrains-agent.jar](https://oss-pic.wangshaogang.com/cdedd4e8-5e3f-4ba8-90d0-0c7aff6ec0af.jar)（建议下载后重命名为jetbrains-agent.jar），可以放在任何位置，例如安装目录的bin目录下。
   **不可删除。**
2. 打开软件，点击菜单栏Help -> Edit Custom VM Options...
   如果提示没有该文件，自动创建即可。
   ![](https://oss-pic.wangshaogang.com/1586692795132-0d109a4a-e396-4674-b68d-25005d8e5832.png)
   添加下面的代码，路径要改为jetbrains-agent.jar的实际路径。

```
-javaagent:C:\Program Files\JetBrains\PyCharm 2018.1.3\bin\jetbrains-agent.jar
```

3. **重启**软件，点击菜单栏Help -> Register
   ![](https://oss-pic.wangshaogang.com/1586692795132-f7bf59de-5655-4a35-b6cf-7ba4788991b3.png)
4. 单选框选择Actication Code，输入下面的内容：
...
![](https://oss-pic.wangshaogang.com/1586692795135-22c2d6b6-84fd-4313-bee5-f341adc9dbb7.png)
